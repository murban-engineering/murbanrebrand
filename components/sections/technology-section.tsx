...
export function TechnologySection() {
  ...
  const descriptionText = "Experience industrial inspection reimagined with cutting-edge technology. Murban Engineering combines advanced NDT methods, precision diagnostics, and comprehensive risk assessment to protect your critical infrastructure. From storage tanks to pipelines, our expertise ensures safety and compliance.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Precision", "Meets", "Industry."].map((word, index) => {
